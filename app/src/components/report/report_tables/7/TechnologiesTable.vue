<template>
  <div class="q-pa-sm q-gutter-sm">
    <q-table title="7 Использование современных образовательных технологий в учебной деятельности и воспитательной работе" :hide-no-data="true" :data="getRows" :columns="getColumns"
